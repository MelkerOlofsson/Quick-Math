<template>
  ...
  <div v-if="answerInput !== null" class="question-answered">
    ...
    <input type="button" value="Finish quiz &#x2192;" @click="$emit('to-next-question', this.questionPassed)">
  </div>
</template>
...
<script>
  ...
  export default {
    data() {
      return {
        question: "8 + 8 = _", // Frågan
        correctAnswer: 16, // Svaret på frågan
        answerOptions: [17, 16, 15, 18], // Svarsalternativen på frågan
        questionPassed: null,
        answerInput: null,
      }
    },
